...
class RequestContextManager:
    ...
    @contextmanager
    def context(self, session_id: str, user_id: Optional[str] = None):
        """上下文管理器（同步）"""
...
class RequestContextAware:
    ...
    def with_context(self, session_id: str, user_id: Optional[str] = None):
        """上下文管理器（向后兼容）"""
        return self.context_manager.context(session_id, user_id)
